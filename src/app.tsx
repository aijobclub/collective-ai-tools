...
const AdminMCPServers = lazy(() => import('./components/admin/resources/AdminMCPServers'));
const AdminMCPClients = lazy(() => import('./components/admin/resources/AdminMCPClients'));
const AdminAITools = lazy(() => import('./components/admin/resources/AdminAITools'));
const AdminCategories = lazy(() => import('./components/admin/resources/AdminCategories'));
const AdminTiers = lazy(() => import('./components/admin/resources/AdminTiers'));
const AdminLanguages = lazy(() => import('./components/admin/resources/AdminLanguages'));
